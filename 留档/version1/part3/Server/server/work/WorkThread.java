package version2.part3.Server.server.work;
...
public class WorkThread implements Runnable{
    ...
    private RpcResponse getResponse(RpcRequest rpcRequest){
        ...
        Method method=null;
        try {
            method= service.getClass().getMethod(rpcRequest.getMethodName(), rpcRequest.getParamTypes()); //Request请求里面定义着请求接口和方法等等参数
