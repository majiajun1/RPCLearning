package version3.part1.Client.proxy;

import lombok.AllArgsConstructor;


import version3.part1.Client.retry.guavaRetry;
import version3.part1.Client.rpcClient.RpcClient;
import version3.part1.Client.rpcClient.impl.NettyRpcClient;

import version3.part1.Client.serviceCenter.ServiceCenter;
import version3.part1.Client.serviceCenter.ZKServiceCenter;
...
//    }
    ...
    @Override
     public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if(serviceCenter.checkRetry(request.getInferfaceName()))
        {
